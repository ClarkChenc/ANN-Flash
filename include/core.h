...
const size_t SUBVECTOR_NUM = 160;		// PQ subvector num, should be times of 16 when using Flash
const size_t CLUSTER_NUM = 256;			// cluster numbers of each subvector

constexpr size_t PRINCIPAL_DIM = 320;		// Rest dimiensions after running PCA
